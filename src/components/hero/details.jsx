...
const Details = ({counter, setCounter}) => {
    const handleAdd = () => {
    ...
    return (  
        <section className='mb-8'>
            <div className="container mx-auto px-4">
                ...
                <div className='mt-4 flex flex-col gap-6'>
                    <div className="bg-neutral-light-grayish-blue w-full flex justify-between items-center px-4 py-3 rounded-lg">
                        <div className='cursor-pointer' onClick={handleSubtract}>
                    ...
                    <button className='flex justify-center w-full gap-2 bg-primary-orange py-4 rounded-lg text-white text-sm cursor-pointer' onClick={handleSubmit}>
            ...
            <div className='text-center mt-4 text-sm'>
                Challenge by <a href="https://www.frontendmentor.io?ref=challenge" target="_blank" rel="noreferrer">Frontend Mentor</a>.  Coded by <a href="https://github.com/Oluwajuwonomoyele?tab=repositories" className='text-primary-orange animate-pulse'>Olutomisin Oluwajuwon</a>.
            </div>
        </section>
    );
}
